    ...
    <div class="container">
        <div class="row pt-2">
            <div class="col col-12">
                <h1>Formulario</h1>
                <form action="{{ route('activity.store') }}" method="POST" class="row g-3 needs-validation">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre actividad"
                                    name="activy_name" value="{{old('activy_name')}}">
                            </div>
                            <div class="col">
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col">
                                ...
                                <input type="time" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9] (AM|PM)" class="form-control" placeholder="Hora Final" name="final_hour" value="{{old('final_hour')}}">
                            </div>
                        </div>
